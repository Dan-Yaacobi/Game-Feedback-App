...
const smtpRequiredVariables = ['SMTP_HOST', 'SMTP_PORT', 'SMTP_USER', 'SMTP_PASS', 'OWNER_EMAIL'];

if (isProduction) {
  const missingSmtpVariables = smtpRequiredVariables.filter((variable) => !process.env[variable]);
